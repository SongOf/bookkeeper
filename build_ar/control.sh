...
export BOOKIE_LOG_FILE="pulsar-autorecovery.log"
# bin/bookkeeper的全局参量
...
function start() {
   ...
   #for docker machine, change default memory limit
    ...
    ${CMD_PREFIX} ${BOOKIE_HOME}/bin/bookkeeper autorecovery >> ${CONSOLE_OUT_LOG} 2>&1
}
...
function init_server_info() {
    # SERVICE_NAME: e.g, level1-air-autorecovery.bookkeeper.dop.ddmq.didi.com
    SERVICE_NAME="test"
